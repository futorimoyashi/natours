      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          if (response.status === 'success') {
            (0, _alert.showAlert)('success', 'Loggin sucesssfully');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          response = _context.sent;
          if (response.status === 'success') {
            (0, _alert.showAlert)('success', "Update ".concat(type, " sucesssfully"));
          } else {
            (0, _alert.showAlert)('error', response.message);
          }
          _context.next = 14;
...
var stripe = Stripe('pk_test_51NLm4BFEjPrPg5e75lSa0uBuS5HawjPDruvpeiKJDiuydScHfZ2ypgYsaYWbMwRozq8U7NyvBua47WrX8urtlF7s00eaj7zGR1');
...
if (updateDataForm) {
  updateDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSetting.updateSetting)(data, 'data');
  });
}
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _updateSetting.updateSetting)(JSON.stringify({
